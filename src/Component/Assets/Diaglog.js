         ...
         <ToastContainer/>
            <form className="Dialog__Container">
                ...
                <div className="button__Container">
                    <Button onClick={handleCreate} type="submit" variant="contained">
                        Create
                    </Button>
    ...
    const handleSend = async () => {
        ...
        if (emaildata.reciever === '' || emaildata.subject === '' || emaildata.message === '') {
            ...
            axios({
                ...
                .catch((err) => {
                    ctx.setisloading({ ...ctx.isloading, send: false });
                    seterr(err.reponse.data.message);
                });
        }
    };
    return (
    ...
    return (
        <div>
            <Dialog open={open} onClose={handleClose}>
                <DialogTitle>Add Students Email</DialogTitle>

                <DialogContent>
                    <p style={{ color: 'red' }}>{err}</p>

                    <DialogContentText>GroupName</DialogContentText>
                    <TextField value={studentdata.name} onChange={handleChange('name')} type={'text'} label={'Name'} />
                    <DialogContentText>Emails (Sperate by Comma (a,b,c,...))</DialogContentText>
